<img width="2046" height="1536" alt="微信图片_2026-05-12_094126_599" src="https://github.com/user-attachments/assets/28f8426d-99bb-4c06-a8d5-a93176a885a9" />
...
🌟 核心特性
    ...
    状态锁定机制 (State Locking)：复刻 Java版本 通道管理器逻辑，一旦声纹相似度突破阈值（默认 0.48），自动锁定身份，防止识别结果在多人环境中跳变。
...
.
├── models/                  # ONNX 模型文件目录
├── speaker_db/              # 声纹底库（每人一个文件夹，存放声纹样本）
├── captured_audio/          # 系统自动捕获的语音语料
├── funnano_vad_speaker.py   # 核心后端主程序
